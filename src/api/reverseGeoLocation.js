class ReverseGeoLocation {
  constructor() {
    this.endpoint = (latitude, longitude) => `https://cors-anywhere.herokuapp.com/https://weather-api-nodejs.herokuapp.com/api/geolocation?latitude=${latitude}&longitude=${longitude}`;
    this.data = null;
  }
